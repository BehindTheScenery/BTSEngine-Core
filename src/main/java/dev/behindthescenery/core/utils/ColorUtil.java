...
//            int color = floatToInt(r) << 24 | floatToInt(g) << 16 | floatToInt(b) << 8 | floatToInt(a);
    ...
    public static void setRGBA_Buffer(MappedByteBuffer buffer, float r, float g, float b, float a) {
    ...
    interface ColorConsumer {
        ...
        void setRGBA_Buffer(MappedByteBuffer buffer, float r, float g, float b, float a);
        ...
        default void putColor(MappedByteBuffer buffer, float r, float g, float b, float a) {
            buffer.putFloat(0, r);
            buffer.putFloat(4, g);
            buffer.putFloat(8, b);
    ...
    public static class DefaultColorConsumer implements ColorConsumer {
        ...
        @Override
        public void setRGBA_Buffer(MappedByteBuffer buffer, float r, float g, float b, float a) {
