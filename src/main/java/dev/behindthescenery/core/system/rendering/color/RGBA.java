...
public class RGBA implements SimpleColor {
    ...
    protected RGBA(int red, int green, int blue, int alpha) {
        this.red = red;
        this.green = green;
        this.blue = blue;
        this.alpha = alpha;
    ...
    public static RGBA of(String hex) {
        hex = hex.replace("#", "");
    ...
    public static RGBA of(int argb) {
        return new RGBA((argb >> 16) & 0xFF, (argb >> 8) & 0xFF, argb & 0xFF, (argb >> 24) & 0xFF);
    }

    public static RGBA of(int red, int green, int blue) {
        return new RGBA(red, green, blue, 255);
    }

    public static RGBA of(int red, int green, int blue, int alpha) {
        return new RGBA(red, green, blue, alpha);
    }

    public static RGBA of(float red, float green, float blue, float alpha) {
        return new RGBA((int) (red * 255), (int) (green * 255), (int) (blue * 255), (int) (alpha * 255));
    }
    ...
    public RGBA copyWithAlpha(int alpha) {
        return new RGBA(red, green, blue, alpha);
    }
